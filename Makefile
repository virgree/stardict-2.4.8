...
pkgdatadir = $(datadir)/stardict
pkglibdir = $(libdir)/stardict
pkgincludedir = $(includedir)/stardict
top_builddir = .
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/stardict-withoutgnome.spec.in \
	$(srcdir)/stardict.spec.in $(top_srcdir)/configure ABOUT-NLS \
...
CONFIG_CLEAN_FILES = stardict.spec stardict-withoutgnome.spec
SOURCES =
DIST_SOURCES =
...
ACLOCAL = ${SHELL} /home/chenfeng/chenfeng/softs/stardict-2.4.8/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/chenfeng/chenfeng/softs/stardict-2.4.8/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/chenfeng/chenfeng/softs/stardict-2.4.8/missing --run autoconf
AUTOHEADER = ${SHELL} /home/chenfeng/chenfeng/softs/stardict-2.4.8/missing --run autoheader
AUTOMAKE = ${SHELL} /home/chenfeng/chenfeng/softs/stardict-2.4.8/missing --run automake-1.9
AWK = gawk
BONOBO_ACTIVATION_IDL = /usr/share/idl/bonobo-activation-2.0
CATALOGS =  cs.gmo de.gmo el.gmo fr.gmo hu.gmo hr.gmo ku.gmo mk.gmo nl.gmo pt_BR.gmo ru.gmo sk.gmo tt.gmo uk.gmo vi.gmo zh_CN.gmo zh_TW.gmo
CATOBJEXT = .gmo
CC = gcc
...
GMOFILES =  cs.gmo de.gmo el.gmo fr.gmo hu.gmo hr.gmo ku.gmo mk.gmo nl.gmo pt_BR.gmo ru.gmo sk.gmo tt.gmo uk.gmo vi.gmo zh_CN.gmo zh_TW.gmo
...
MAKEINFO = ${SHELL} /home/chenfeng/chenfeng/softs/stardict-2.4.8/missing --run makeinfo
...
PACKAGE_STRING = stardict 2.4.8
PACKAGE_TARNAME = stardict
PACKAGE_VERSION = 2.4.8
PATH_SEPARATOR = :
PKG_CONFIG = /usr/bin/pkg-config
POFILES =  cs.po de.po el.po fr.po hu.po hr.po ku.po mk.po nl.po pt_BR.po ru.po sk.po tt.po uk.po vi.po zh_CN.po zh_TW.po
POSUB = po
PO_IN_DATADIR_FALSE = 
PO_IN_DATADIR_TRUE = 
RANLIB = ranlib
...
infodir = ${prefix}/info
install_sh = /home/chenfeng/chenfeng/softs/stardict-2.4.8/install-sh
...
target_alias = 
SUBDIRS = src tests pixmaps po help data doc
EXTRA_DIST = \
	ChangeLog  		\
	README 			\
	INSTALL			\
	...
	dictionary.spec	\
	treedict.spec	\
	stardict.dev stardict.ico stardict-uninst.ico stardict-installer.nsi \
	omf.make		\
	xmldocs.make 		\
	intltool-extract.in 	\
	intltool-merge.in 	\
...
stardict.spec: $(top_builddir)/config.status $(srcdir)/stardict.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
stardict-withoutgnome.spec: $(top_builddir)/config.status $(srcdir)/stardict-withoutgnome.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
